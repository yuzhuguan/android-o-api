package cn.codef1.apidemo.demo.picture;
...
public class PictureInPicture extends AppCompatActivity {
    ...
    void updatePictureInPictureActions(
        ...
        final PendingIntent intent =
                PendingIntent.getBroadcast(
                        PictureInPicture.this,
                        requestCode,
                        new Intent(ACTION_MEDIA_CONTROL).putExtra(EXTRA_CONTROL_TYPE, controlType),
                        0);
        final Icon icon = Icon.createWithResource(PictureInPicture.this, iconId);
        actions.add(new RemoteAction(icon, title, title, intent));

        // Another action item. This is a fixed action.
        actions.add(
                new RemoteAction(
                        Icon.createWithResource(PictureInPicture.this, R.drawable.ic_info_24dp),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button switchExampleButton = (Button) findViewById(R.id.switch_example);
